...
def depute
  ...
  tab.map { |i| { "first_name" => get_first_name(i), "last_name" => get_last_name(i), "email" => get_email(i)} }
  #tab.map[0..5] { |i| { "first_name" => get_first_name(i), "last_name" => get_last_name(i), "email" => get_email(i)} } to be quicker
end
